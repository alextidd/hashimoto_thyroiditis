...
# save
saveRDS(loh_snps, "out/phase_snps/phase_snps_cache/loh_genotyped_chr1_snps.rds")
```

```{r reload_snps, eval = T}
loh_snps <- readRDS("out/phase_snps/phase_snps_cache/loh_genotyped_chr1_snps.rds")
```
...
plate3_wellA2 %>%
  ...
  saveRDS("out/phase_snps/phase_snps_cache/plate3_wellA2_phased_snps.rds")
```
...
# save breakpoints
breakpoints_and_haps %>%
  readr::write_tsv(file.path(params$cache_path, "breakpoints_and_haps.tsv"))
```