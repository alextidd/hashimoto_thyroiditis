#!/bin/bash
# cd /nfs/casm/team268im/at31/projects/hashimoto_thyroiditis ; bsub -q basement -M2000 -R 'span[hosts=1] select[mem>2000] rusage[mem=2000]' -J 02_dnahyb_run -o log/%J_02_dnahyb_run.out -e log/%J_02_dnahyb_run.err 'bash src/nf-resolveome/02_dnahyb_run.sh'
...
(
  ...
  nextflow run $NFS_TEAM/nextflow/nf-resolveome \
    ...
    --baf_chrs 1,4,9 \
    --out_dir ./ \
    -w $LUSTRE_TEAM/resolveome/work/nf-resolveome/dnahyb/ \
    -resume \
    -N at31@sanger.ac.uk \
    -with-tower
)
