...
# run
(
  cd out/resolveome/basejumper/bj-somatic-variantcalling-develop/dnahyb/$donor_id/
  nextflow run $wd/../nextflow/external/basejumper/bj-somatic-variantcalling-parabricks-develop \
    ...
    -w $LUSTRE_TEAM/projects/hashimoto_thyroiditis/work/basejumper/bj-somatic-variantcalling/dnahyb/$donor_id/ \
    -profile singularity \
    --architecture "x86_64" \
    -resume \
    -N at31@sanger.ac.uk
...
# bsub -q basement -M10000 -R 'span[hosts=1] select[mem>10000] rusage[mem=10000]' -J 03g_basejumper_somatic-variantcalling-develop_dnahyb_symlink -o "log/%J_03g_basejumper_somatic-variantcalling-develop_dnahyb_symlink.out" "source ~/.bashrc && replace_symlinks out/resolveome/basejumper/bj-somatic-variantcalling/dna/"