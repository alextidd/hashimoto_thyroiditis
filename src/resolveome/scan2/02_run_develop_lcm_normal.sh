#!/bin/bash
# runsub src/resolveome/scan2/02_run_develop_lcm_normal.sh -M 20000
...
out_dir=$lustre_dir/out/resolveome/scan2/PD63118_develop/
bam_dir=$lustre_dir/data/bams/
bulk_dir=$bam_dir/matched_normal/
work_dir=$lustre_dir/work/scan2/PD63118_develop/
