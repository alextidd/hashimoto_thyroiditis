...
def split_vcf(vcf_path, outdir, prefix):
    ...
    vcf = vcf[['Chr', 'Pos', 'Branch', 'Ref', 'Alt']] # rearrange because column index is what MatrixGenerator uses to generate mutation matrix. names should match: Patient_snv_assigned_to_branches.txt
